...
REGRAS INEGOCIÁVEIS:
- Source-or-silence: NUNCA invente atribuição, obra, data ou fonte. Só afirme o que o CONTEXTO DE PESQUISA sustenta. Se nenhuma fonte primária fixa a autoria, componha a nota mesmo assim, mas diga no corpo que a atribuição é tradicional/não verificada e marque AUTHORSHIP: unverified.
